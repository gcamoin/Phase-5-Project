...
user1 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXZhdGFyfGVufDB8fDB8fHww")
user2 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://plus.unsplash.com/premium_photo-1658527049634-15142565537a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YXZhdGFyfGVufDB8fDB8fHww")
user3 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8YXZhdGFyfGVufDB8fDB8fHww")
user4 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YXZhdGFyfGVufDB8fDB8fHww")
user5 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGF2YXRhcnxlbnwwfHwwfHx8MA%3D%3D")
user6 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8YXZhdGFyfGVufDB8fDB8fHww")
user7 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-render-avatar-character_23-2150611713.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
user8 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-rendering-avatar_23-2150833562.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
user9 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-render-avatar-character_23-2150611716.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
user10 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-illustration-human-avatar-profile_23-2150671159.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
user11 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436180.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
user12 = User.create(username: Faker::Internet.username(specifier: 5..10), password: Faker::Internet.password(min_length: 5, max_length: 15), email: Faker::Internet.email, avatar: "https://img.freepik.com/free-psd/3d-rendering-avatar_23-2150833560.jpg?size=626&ext=jpg&ga=GA1.2.194865327.1708363490&semt=ais")
...
review8 = Review.create(content: "One of the worst books I have ever read.", book_id: b8.id, user_id: user8.id)
...
review24 = Review.create(content: "This book will become a timeless classic. It had evrything that a good story should have and the author did an amazing job telling it.", book_id: b24.id, user_id: user12.id)
